...
void MPU6050Driver::handleInput()
{
  ...
  message.angular_velocity.x = mpu6050_->getAngularVelocityX() * 0.017453292519943295;  // deg/s -> rad/s (ROS standard)
  message.angular_velocity.y = mpu6050_->getAngularVelocityY() * 0.017453292519943295;  // deg/s -> rad/s (ROS standard)
  message.angular_velocity.z = mpu6050_->getAngularVelocityZ() * 0.017453292519943295;  // deg/s -> rad/s (ROS standard)
